...
const VehicleServiceForm = () => {
  const [formData, setFormData] = useState({
    ...
    problems: {
      ...
      reducedRange: false,
      motorNotRunning: false,
      unusualNoise: false,
      warningLight: false,
      brakeIssue: false,
      softwareGlitch: false,
      chargingPortProblem: false,
      other: false
    },
    otherDetails: ''
  })
  ...
  const serviceAmount = calculateServicePrice('vehicle', formData.vehicleType)
    ...
    <div className="pt-20">
      ...
      >
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Vehicle Service Request</h1>
          <p className="text-xl max-w-3xl">
            Complete the form below to schedule a vehicle service appointment with our expert technicians.
          </p>
        </div>
      </motion.section>
          ...
          {!isSubmitted ? (
                  ...
                  <div className="form-section">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          id="batteryNotCharging"
                          name="batteryNotCharging"
                          checked={formData.problems.batteryNotCharging}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="batteryNotCharging" className="ml-2 text-sm text-gray-700">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          id="reducedRange"
                          name="reducedRange"
                          checked={formData.problems.reducedRange}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="reducedRange" className="ml-2 text-sm text-gray-700">
                          Reduced Range
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          checked={formData.problems.motorNotRunning}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="motorNotRunning" className="ml-2 text-sm text-gray-700">
                          Motor Not Running
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          id="unusualNoise"
                          name="unusualNoise"
                          checked={formData.problems.unusualNoise}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="unusualNoise" className="ml-2 text-sm text-gray-700">
                          Unusual Noise
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          id="warningLight"
                          name="warningLight"
                          checked={formData.problems.warningLight}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="warningLight" className="ml-2 text-sm text-gray-700">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          id="brakeIssue"
                          name="brakeIssue"
                          checked={formData.problems.brakeIssue}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="brakeIssue" className="ml-2 text-sm text-gray-700">
                          Brake Issue
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          id="softwareGlitch"
                          name="softwareGlitch"
                          checked={formData.problems.softwareGlitch}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="softwareGlitch" className="ml-2 text-sm text-gray-700">
                          Software Glitches
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          id="chargingPortProblem"
                          name="chargingPortProblem"
                          checked={formData.problems.chargingPortProblem}
                          onChange={handleChange}
                          className="checkbox-field"
                        />
                        <label htmlFor="chargingPortProblem" className="ml-2 text-sm text-gray-700">
                  ...
                  <div className="form-section">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-gray-700">Vehicle Diagnostic Service:</span>
                        <span className="font-medium">{formatINR(serviceAmount)}</span>
                      </div>
                      <p className="text-sm text-gray-500 mb-3">
                        This fee covers a comprehensive diagnostic evaluation of your vehicle. 
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Thank you for choosing BHARAT EVs for your vehicle service needs. We've received your request and payment.
              </p>
